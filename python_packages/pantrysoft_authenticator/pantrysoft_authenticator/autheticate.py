from pantrysoft_authenticator.playwright_driver import PlaywrightPantrySoftDriver
...
def get_php_session_id(username: str, password: str) -> str:
    ...
    pantrysoft_driver = PlaywrightPantrySoftDriver(PANTRYSOFT_URL, username, password)
    try:
